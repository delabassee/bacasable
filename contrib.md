# GlassFish Fork Pull Request Based Workflow
...
1. If an external contributor (a contributor who is not a member of the GitHub 'GlassFish' team) raises a Pull Request, **glassfishrobot** will update the Pull Request with the following two comments  
